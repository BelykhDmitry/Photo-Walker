...
//import com.dmitriib.challenge.ui.screens.currentRecord.CurrentRecordScreenState
...
//        val statesList = mutableListOf<CurrentRecordScreenState>()
//        backgroundScope.launch(UnconfinedTestDispatcher(testScheduler)) {
//            viewModel.currentRecordScreenStateFlow.toList(statesList)
//        }
...
//        assert(walkingState is CurrentRecordScreenState.Started)
//        assertEquals(listOf(testImageInfo), (walkingState as CurrentRecordScreenState.Started).images)
//    }
//
//    @OptIn(ExperimentalCoroutinesApi::class)
//    @Test
